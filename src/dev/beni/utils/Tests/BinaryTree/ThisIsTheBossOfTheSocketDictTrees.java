...
public class ThisIsTheBossOfTheSocketDictTrees {
    ...
    public ThisIsTheBossOfTheSocketDictTrees(String key, String value){
    ...
    public void deleteNode(String keyOfNodeToBeDeleted) {
        ...
        //if the node to be deleted has successor nodes on its left and right
            ...
            if(direction == 0){
                ...
                for(int i = 0; i < nodesOnTheRight.size(); i++) {
                    insert(nodesOnTheRight.get(i).key, nodesOnTheRight.get(i).key);
                }
                ...
                for(int i = 0; i < nodesOnTheLeft.size(); i++) {
                    insert(nodesOnTheLeft.get(i).key, nodesOnTheLeft.get(i).key);
                }
    ...
    public ThisIsTheBossOfTheSocketDictTrees fromString(String string){
        ThisIsTheBossOfTheSocketDictTrees converted_from_String;
        ...
        converted_from_String = new ThisIsTheBossOfTheSocketDictTrees(firstnode.key, firstnode.value);
        ...
        while(end <= string.length()) {
            ...
            converted_from_String.insert(nextnode.key, nextnode.value);

        }
        converted_from_String.traverseInOrder();
